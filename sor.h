...
//global variable to keep track of maximum residual across threads
double temp_Rmax;

/* Function: sorSlice
 * ------------------------
 * iterates over given slince of array once
 *
 * initparams: void pointer to an InitParams struct
 *
...
/* Function: sor
 * ------------------------
 * runs the sor algorithm on a given array until convergence
 *
 * V:       inital potential array
 * boolarr  boolean array for grid
 * nx:      number of rows
 * ny:      number of columns
 * tol      tolerance required for convergence
 * cores:   number of cores to use
 *
 * returns: MainReturn struct
 */
